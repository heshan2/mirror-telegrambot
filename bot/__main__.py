...
def stats(update, context):
    ...
    stats = f'┏━━👹<b><u>𝔹𝕆𝕋 𝕊𝕋𝔸𝕋𝕀𝕊𝕋𝕀ℂ𝕊</u></b>👹\n' \
            f'┃\n' \
            f'┃\n' \
            f'┣ ➟<b> ᴮᵒᵗ ᵁᵖᵗⁱᵐᵉ </b>          : <font size="-1">{currentTime}</font>\n' \
            f'┣ ➟<b> ᵀᵒᵗᵃˡ ᴰᶦˢᵏ ˢᵖᵃᶜᵉ</b>  : {total}\n' \
            f'┣ ➟<b> ᵀᵒᵗᵃˡ ᵁˢᵉᵈ ˢᵖᵃᶜᵉ</b> : {used}\n' \
            f'┣ ➟<b> ᵀᵒᵗᵃˡ ᶠʳᵉᵉ ˢᵖᵃᶜᵉ</b>  : {free}\n' \
            f'┣ ➟<b> ᵀᵒᵗᵃˡ ᵁᵖˡᵒᵃᵈ</b>         : {sent}\n' \
            f'┣ ➟<b> ᵀᵒᵗᵃˡ ᴰᵒʷⁿˡᵒᵃᵈ</b>    : {recv}\n' \
            f'┣ ➟<b> 𝗖𝗣𝗨</b>                      : {cpuUsage}%\n' \
            f'┣ ➟<b> 𝗥𝗔𝗠</b>                     : {memory}%\n' \
            f'┣ ➟<b> 𝗗𝗜𝗦𝗞</b>                     : {disk}%\n' \
            f'┃\n' \

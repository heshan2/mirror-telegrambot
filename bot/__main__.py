...
'''
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        ...
        sendMessage(f"You cont use me beacuse you are not a Authorized user.", context.bot, update)
